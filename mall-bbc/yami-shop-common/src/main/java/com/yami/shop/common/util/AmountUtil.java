...
public class AmountUtil {
    ...
    */
    ...
    /** 最小 0  **/
    public static Long minZero(Long amount){
    ...
    /** 美化百分比  **/
    public static String convertPercentage(BigDecimal num){
        return num.multiply(new BigDecimal("100")).setScale(2, BigDecimal.ROUND_HALF_UP).toPlainString() + "%";
    }
